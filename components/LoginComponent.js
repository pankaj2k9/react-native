...
import { FormInput, CheckBox, Button, Icon } from 'react-native-elements';
...
class RegisterTab extends Component {
    ...
    static navigationOptions = {
        ...
        tabBarIcon: ({ tintColor, focused }) => (
            <Icon
                name='user-plus' type='font-awesome'
                size={24}
                iconStyle={{ color: tintColor }}
            />
        )
...
const Login = createBottomTabNavigator({
    ...
    Register: RegisterTab
        ...
        tabBarOptions: {
            activeBackgroundColor: '#9575CD', inactiveBackgroundColor: '#D1C4E9',
